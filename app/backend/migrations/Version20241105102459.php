 ...
 */
final class Version20241105102459 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book ADD language_id INT NOT NULL, ADD rating INT NOT NULL, ADD number_of_pages INT NOT NULL, ADD img VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book DROP language_id, DROP rating, DROP number_of_pages, DROP img');
    }
}
